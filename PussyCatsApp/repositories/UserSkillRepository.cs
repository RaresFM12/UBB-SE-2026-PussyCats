...
namespace PussyCatsApp.repositories
{
    public class UserSkillRepository 
    {
        ...
        private readonly string connectionString = "Data Source=DESKTOP-C5LH746\\SQLEXPRESS;Initial Catalog=PussyCatsDB;Integrated Security=True;Trust Server Certificate=True";
